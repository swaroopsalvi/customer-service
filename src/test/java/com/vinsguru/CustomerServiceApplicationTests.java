...
//@MockitoBean is used to add Mockito mocks to a Spring ApplicationContext. It does not create RestClient or MovieClient beans
// but instead creates Mockito mocks of those types and adds them to the ApplicationContext
